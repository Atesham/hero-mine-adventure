...
const MiningCard = () => {
  ...
  //         className="glass-card rounded-3xl p-6 md:p-8 shadow-lg w-full" 
  //       >
  ...
  //           </motion.div>
  //           <h2 className="text-2xl md:text-3xl font-bold">Ad Instructions</h2> {/* Larger text on desktop */}
  //           <p className="text-muted-foreground mt-2 md:text-lg"> {/* Larger text on desktop */}
  //             Follow these steps carefully to earn your coins
  //           </p>
  //         </div>
  
  //         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6"> {/* Changed to grid layout */}
  //           <motion.div 
  //             initial={{ opacity: 0, y: 20 }}
  //             animate={{ opacity: 1, y: 0 }}
  //             transition={{ delay: 0.1 }}
  //             className="bg-secondary/50 rounded-lg p-4 h-full" >

  //             <h3 className="font-medium flex items-center">
  //               <span className="bg-primary text-white rounded-full w-6 h-6 flex items-center justify-center mr-3">1</span>
  //               Ad Tab Will Open
  //             </h3>
  //             <p className="text-sm md:text-base text-muted-foreground mt-1 ml-9"> {/* Larger text */}
  //               A new tab will open with the ad. Don't close it until mining completes.
  //             </p>
  //             <div className="ml-9 mt-2 flex items-center text-xs md:text-sm text-green-500"> {/* Larger text */}
  ...
  //               Switch Back Safely
  //             </h3>
  //             <p className="text-sm md:text-base text-muted-foreground mt-1 ml-9">
  //               You can return to this tab while the ad runs in background.
  //             </p>
  //             <div className="ml-9 mt-2 flex items-center text-xs md:text-sm text-green-500">
  ...
  //             </p>
  //             <div className="ml-9 mt-2 flex items-center text-xs md:text-sm text-red-500">
  ...
  //             <Button 
  //               variant="outline" 
  //               className="w-full rounded-xl py-5 md:py-6" 
  ...
  if (showAdInstructions) {
    return (
      <div className="w-full max-w-2xl mx-auto px-4"> {/* Max width increased to 2xl (42rem/672px) */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="glass-card rounded-3xl p-6 shadow-lg w-full">
          <div className="text-center mb-6">
            <motion.div 
              animate={{ scale: [1, 1.1, 1] }}
              transition={{ repeat: Infinity, duration: 2 }}
          ...
          <div className="space-y-4 mb-6"> {/* Vertical layout maintained */}
            <motion.div 
