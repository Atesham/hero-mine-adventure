...
const LeaderboardSkeleton = () => (
  <div className="glass-card rounded-xl p-6 overflow-hidden">
    <div className="flex justify-between items-center mb-6">
      <div className="h-8 w-32 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-lg animate-pulse"></div>
      <div className="h-8 w-24 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-lg animate-pulse"></div>
    </div>
        ...
        <thead>
          <tr className="border-b border-secondary/50">
            <th className="text-left py-4 px-4">
              <div className="h-5 w-16 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded animate-pulse"></div>
            </th>
            <th className="text-left py-4 px-4">
              <div className="h-5 w-16 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded animate-pulse"></div>
            </th>
            ...
            <th className="text-right py-4 px-4">
              <div className="h-5 w-24 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded animate-pulse"></div>
            </th>
          </tr>
        </thead>
        <tbody>
          {[...Array(5)].map((_, i) => (
            <tr key={i} className="border-b border-secondary/20">
              <td className="py-4 px-4">
                <div className="h-6 w-6 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-full animate-pulse"></div>
              </td>
              <td className="py-4 px-4">
                <div className="h-5 w-32 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded animate-pulse"></div>
              </td>
              <td className="py-4 px-4">
                <div className="h-6 w-20 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded-full animate-pulse"></div>
              </td>
              <td className="py-4 px-4 text-right">
                <div className="h-5 w-16 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 rounded animate-pulse ml-auto"></div>
              </td>
            </tr>
          ))}
        </tbody>
