...
//// --------------------working just refer code link is not working -----------------
...
//   const [verificationCheckCount, setVerificationCheckCount] = useState(0);
//   const [isVerifying, setIsVerifying] = useState(false);
//   const [referralChecked, setReferralChecked] = useState(!!urlReferralCode);
...
//   // Check and apply referral code from URL on component mount
//   useEffect(() => {
//     if (urlReferralCode) {
//       setValue('referralCode', urlReferralCode);
//       trigger('referralCode').then(() => {
//         checkReferralCode(urlReferralCode);
//         toast.info('Referral code applied from link!', {
//           description: 'You\'ll get bonus coins if this code is valid'
//         });
//       });
//     }
//   }, [urlReferralCode, setValue, trigger]);
...
//       onReferralCheck(urlReferralCode).then(isValid => {
//         setReferralValid(isValid);
//         if (isValid) {
//           toast.info('Referral code applied from link!', {
//             description: 'You\'ll get bonus coins if this code is valid'
...
//       });
//     }
//   }, [urlReferralCode, onReferralCheck]);
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                {referralValid !== null && referralCode && (
                  <span className={`text-xs ${referralValid ? 'text-green-600' : 'text-destructive'}`}>
                    {referralValid ? 'Valid!' : 'Invalid'}
                  </span>
                )}
